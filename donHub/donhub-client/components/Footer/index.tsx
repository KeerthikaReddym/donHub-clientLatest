        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base italic leading-relaxed text-body-color dark:text-body-color-dark">
                  Embrace the Power of Your Campus Community with DonHub!
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="https://bitbucket.org/keerthireddy2/donhub/src/master/"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              ...
              <a href="https://www.bitbucket.com" rel="nofollow noopener">
                Team Code Creepers
              </a>
            </p>
          </div>
