      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="ml-24 flex w-full items-center justify-between px-4">
              <div>
                <button
                ...
                >
                  <ul className="ml-18 flex flex-col lg:ml-4 lg:flex-row lg:items-center lg:justify-center lg:space-x-4">
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={`flex items-center justify-center py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
