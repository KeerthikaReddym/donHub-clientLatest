 ...
 * 
 * import com.donHub.donHub.model.User; import
 * com.donHub.donHub.service.Authentication; import
 * com.donHub.donHub.service.UserServiceI;
 * 
 * @RestController
 * 
 ...
 *//**
	 ...
	 */
/*
 * @GetMapping("/getAllUsers") public ResponseEntity<Object> getAllUsers() {
 * List<User> users = userService.getAllUsers(); return users != null ?
 * ResponseEntity.status(HttpStatus.FOUND).body(users) :
 ...
 *//**
	 ...
	 */
/*
 * @GetMapping("/getUserById/{userId}") public ResponseEntity<Object>
 * getUserById(@PathVariable Long userId) { Optional<User> user =
 * userService.getUserById(userId); return user != null ?
 ...
 *//**
	 ...
	 */
/*
 * @PostMapping() public ResponseEntity<Object> addUser(@RequestBody User data)
 * { Optional<User> user = userService.createUser(data); //send the user a code
 * to his mail id and prompt him to send the code back
 * authentication.authenticate(data); return user != null ?
 * ResponseEntity.status(HttpStatus.FOUND).body(user) :
 * ResponseEntity.status(HttpStatus.NOT_FOUND).body("No user found!");
 * 
 * }
 ...
 * updateUser(@PathVariable Long userId, @RequestBody User updateUser) {
 ...
 *//**
	 ...
	 *//*
		 ...
		 * deleteUserById(@PathVariable Long userId) { Boolean isDeleted =
